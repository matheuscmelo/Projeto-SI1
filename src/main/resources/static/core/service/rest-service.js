app.service("RESTService", function ($http) {
	...
	function searchEspecialty(especialty){
		return $http.get(API_PATH + "unidade/especialidade/" + especialidade);
	}

	function registerAdmin(adm) {
		return $http.post(API_PATH + "prefeitura/",adm);
	}

	var service = {
		registerAdmin: registerAdmin,
		searchEspecialty: searchEspecialty,
